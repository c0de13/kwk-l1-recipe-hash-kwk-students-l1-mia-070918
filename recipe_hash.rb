...
def ingredients_and_amounts(perfect_10_recipe)
  ke= perfect_10_recipe.keys
  va = perfect_10_recipe.values 
  count = 0 
  while count < perfect_10_recipe.length
    puts "#{ke[count]} #{va[count]}"
    count += 1 
  end   
end
...
def amounts(perfect_10_recipe)
  puts perfect_10_recipe.values.length
end
...
def number_ingredients(perfect_10_recipe)
  return perfect_10_recipe.values.length
end
